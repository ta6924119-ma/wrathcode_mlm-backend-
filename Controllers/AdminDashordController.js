...
// =================  GET SINGLE KYC DETAILS ( DOWNLOAD LINKS) =================
      ...
      data: {
        ...
        documents: {
          frontImage: kyc.frontImage
            ? `${baseUrl}${uploadPath}${kyc.frontImage}`
            : null,
          backImage: kyc.backImage
            ? `${baseUrl}${uploadPath}${kyc.backImage}`
            : null,
          selfie: kyc.selfiewithidnumber
            ? `${baseUrl}${uploadPath}${kyc.selfiewithidnumber}`
            : null,
          addressProof: kyc.addressImage
            ? `${baseUrl}${uploadPath}${kyc.addressImage}`
            : null,
        },
      },
    });
